...
// ── Module-scope sub-components (stable identity = no remount on Home re-render) ──
...
const RemainingArticlesSection = ({ articles }) => {
...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-brand-black w-full">
      ...
      />
      {/* News Flash Ticker */}
      <NewsFlashTicker articles={latestArticles} />
      ...
      <div className="w-full px-4 py-6">
        <div className="max-w-screen-2xl mx-auto">
          ...
          <div className="flex flex-col lg:flex-row gap-4 items-start">
            ...
            <div className="w-full lg:w-1/2 items-start">
              <LatestArticlesSection articles={latestArticles} loading={loading} />
            </div>
          </div>
          ...
          <RemainingArticlesSection articles={latestArticles} />
        </div>
      </div>
    </div>
  );
